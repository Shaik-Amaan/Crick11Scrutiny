...
from utils import First_Innings_Score_Prediction_IPL
#
import os
import joblib
#import numpy as np 
...
First_Innings_Score_Prediction_IPL = pickle.load(open(filename, 'rb'))
...
def predict():
    ...
    if request.method == 'POST':
        ...
        my_prediction = int(First_Innings_Score_Prediction_IPL.predict(data_ipl)[0])
